...
// refer to Module (if they choose; they can also define Module)
  ...
  (function() {
    ...
    var loadPackage = function(metadata) {
      ...
      var PACKAGE_NAME = 'clientV0.3.data';
      var REMOTE_PACKAGE_BASE = 'clientV0.3.data';
...
Module['FS_createPath']("/", "assets", true, true);
      ...
      function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          }          Module['removeRunDependency']('datafile_clientV0.3.data');

      };
      Module['addRunDependency']('datafile_clientV0.3.data');
    ...
    loadPackage({"files": [{"filename": "/assets/demo.toml", "start": 0, "end": 214}, {"filename": "/assets/great.toml", "start": 214, "end": 247}], "remote_package_size": 247});
...
var wasmBinaryFile;
  wasmBinaryFile = 'clientV0.3.wasm';
...
var ASM_CONSTS = {
  79988: ($0) => { createButton(UTF8ToString($0)); }
};
